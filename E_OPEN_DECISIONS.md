...
| no-redemption-rule | **Reconciliation and redemption are deliberately UNWRITTEN.** Nothing closes the door; it is simply not marked. Two standing constraints on all future edits: **do not sign-post it**, and **do not brick it up** — `hollow` restricts what *he* can do and must never restrict what others may do to, for, or beside him | G·there-is-no-redemption-rule |
